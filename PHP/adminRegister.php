	...
	<section id="page">
			...
			<section id="register" class="visible">
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="login-box-plain">
								...
								<div class="divide-40"></div>
								<form name="registerForm" action="adminRegisterProcess.php" method="post">
								  <div class="form-group">
								  ...
								  <div class="form-group"> 
									<label for="exampleInputPassword2">密码确认</label>
									<i class="fa fa-check-square-o"></i>
									<input name="ConfirmPwd" type="password" class="form-control" id="exampleInputPassword2" >
								  </div>
								  <div class="form-actions">
					...
					{
							if($errno == 15)
								echo "<center><font style='color:red;'>两次输入的密码不一致！</font></center>";
							else if($errno == 16)
								echo "<center><font style='color:red;'>输入的用户名已存在！</font></center>";
							else{}
